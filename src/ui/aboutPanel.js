  ...
  constructor(host) {
    ...
    for (
      const t of [
        ...
        "Display (parameter panel): draw the laid yarns as lines (like the free yarns) or as flat tapes; colour them by braid angle, slip ratio, curvatures or contact pressure, and the mandrel by Gaussian or mean curvature. Braid-angle colours span the range of the current run by default; the α colour scale switches to a custom min / mid / max range or to the full 0–90°.",
